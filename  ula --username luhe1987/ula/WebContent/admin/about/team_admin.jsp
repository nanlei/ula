    ...
    <div id="sidebar"><!--侧边栏-->
		<div id="sidemenu">
			<ul>
				...
				<li class="current"><a href="team!admin.action">团队介绍</a></li>
			
				<li><a href="biz!admin.action">业务范围</a></li>
			
				<li><a href="memory!admin.action">美好回忆</a></li>
			</ul>
		</div>
	</div>
	<!--主体内容-->
	...
	<c:if test="${teamInfo!=null}">
		<table id="customers">
			...
			<tr class="alt">
				...
				<td class="operation"><a href="team!edit.action"><img
