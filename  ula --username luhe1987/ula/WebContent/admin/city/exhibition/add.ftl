<@p.page>
	...
	<@app.naviInfo helpInfoTitle="查看页面说明" helpInfoContent="本页面您可以添加展会信息部分的文章">
...
<form name="articleForm" action="addExhibition.action" method="post" onsubmit="return validateForm(this)">
