<@p.page>
	...
	<@app.naviInfo helpInfoTitle="查看页面说明" helpInfoContent="本页面您可以修改展会信息部分的文章">
...
<form name="articleForm" action="updateExhibition.action?articleId=${exhibitionInfo.ID}" method="post" onsubmit="return validateForm(this)">
