<@p.page title="图片管理" body="style=\"margin:0;color:#fff\" scroll=\"no\"">
				...
				<tr>
					<td>
						<@app.header>
							...
							<td width="80" class="tdselected fbg"><div><a class="navbar" href="${base}/pic/admin.action">图片管理</a></div></td>
							<td width="80" class="tdnormal"><div><a class="navbar" href="${base}/user/admin.action">用户管理</a></div></td>
