...
public class TourAction extends AnonymousAction {
    ...
    public String info() throws Exception {
        tour = getServiceManager().getFrontService().getTourById(getParametersAsMap());
        baseInfo();
        return "info";
    }
    ...
    public String normal() throws Exception {
        tourList = getServiceManager().getFrontService().getTourByCategoryTag(
                CommonConstants.TAG_TOUR_NORMAL);
        baseInfo();
        return "normal";
    }
     ...
     * @throws Exception
     */
    public String individual() throws Exception {
        tourList = getServiceManager().getFrontService().getTourByCategoryTag(
                CommonConstants.TAG_TOUR_INDIVIDUAL);
        baseInfo();
        return "individual";
    }
