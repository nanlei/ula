...
public class CommonAction extends BaseAction {
     ...
     */
    public String view() {
        PagingList linksFromSession = (PagingList)super.getHttpSessionAsMap().get(
        ...
        try {
            ...
            if (recommendation == null || recommendation.isEmpty()) {
                // 获得本月推荐的所有内容
                recommendation = super.getServiceManager().getProgramService()
                        .getInfo(CommonConstants.ID_PROGRAM_MONTH_RECOMMENDATION);
                // 获取title
