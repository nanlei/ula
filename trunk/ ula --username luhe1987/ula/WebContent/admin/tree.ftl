...
var treeMenu = [
	...
	{ level:2, name:"景点、公园"},
	{ level:3, name:"市内", link:"city/tour.action?type=dalian"},
	{ level:3, name:"旅顺", link:"city/tour.action?type=lvshun"},
	{ level:3, name:"开发区、金石滩", link:"city/tour.action?type=devzone"},
	...
	{ level:2, name:"汉语学习", link:"program/chineselanguage!admin.action"},
	{ level:2, name:"夏令营", link:"program/summercamp!admin.action"},
	{ level:2, name:"温泉游", link:"program/hotspring!admin.action"},
	{ level:2, name:"乡村游", link:"program/countryside!admin.action"},
	{ level:2, name:"展览", link:"program/exhibition!admin.action"},
