<@p.page>
	...
	<@app.naviInfo helpInfoTitle="查看页面说明" helpInfoContent="本页面您可以修改大连美食部分的文章">
...
<table class="default" width="100%">
	...
	<tr>
		<td>标题</td><td colspan="3"><input type="text" name="title" emptyInfo="请填写文章标题" value="${foodInfo.TITLE}" size="80"></td>
	</tr>
	<#--
		<td>封面图片</td>
		<td>
