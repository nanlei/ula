<@p.page>
	<@app.naviBar navi="关于城市,景点，公园,添加文章" />
	<@app.naviInfo helpInfoTitle="查看页面说明" helpInfoContent="本页面您可以添加关于城市部分的文章">
...
<form name="articleForm" action="addTour.action" method="post" onsubmit="return validateForm(this)">
<table class="default" width="100%">
	...
	<tr>
		...
		<td>
			<select name="articleType" emptyInfo="请选择文章类别">
				...
				<option value="lvshun">旅顺</option>
				<option value="devzone">开发区，金石滩</option>
			</select>
		</td>
	...
	<tr>
		...
		<td>参考价格</td>
		<td><input type="text" name="price" numberInfo="请填写价格，并且是数字格式"></td>
	</tr>
	<tr>
