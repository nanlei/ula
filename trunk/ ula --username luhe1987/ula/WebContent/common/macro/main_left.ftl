...
<#-- 关于我们 -->
<#macro main_left_about>
		<div id="main_left">
			<div id="left_title"><@s.property value="%{getText('front.aboutus.title')}"/></div>
			<div id="left_menu">
				<ul class="left_first_menu">
                	<li><a href="${base}/about/company.html"><@s.property value="%{getText('front.about.company')}"/></a></li>
                    <li><a href="${base}/about/business.html"><@s.property value="%{getText('front.about.business')}"/></a></li>
                    <li><a href="${base}/about/team.html"><@s.property value="%{getText('front.about.team')}"/></a></li>
                    <li><a href="${base}/about/memory.html"><@s.property value="%{getText('front.about.memory')}"/></a></li>
				</ul>
			</div>
			<div class="clear"></div>
			<div id="left_bottom"></div>
...
<#-- 在线咨询 -->
<#macro main_left_online>
		<div id="main_left">
			<div id="left_title"><@s.property value="%{getText('front.nav.online.contact')}"/></div>
			<div id="left_menu">
				<ul class="left_first_menu">
                	<li><a href="${base}/about/company.html"><@s.property value="%{getText('front.online.chat')}"/></a></li>
                    <li><a href="${base}/about/business.html"><@s.property value="%{getText('front.online.email')}"/></a></li>
				</ul>
			</div>
			<div class="clear"></div>
			<div id="left_bottom"></div>
