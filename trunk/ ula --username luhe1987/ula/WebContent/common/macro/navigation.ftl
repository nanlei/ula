...
<#macro navigation c_index c_city c_tour c_service c_search c_contact>
    <div id="nav">
    	<ul>
    		...
    		<li<#if locale='ru'> class="sp"</#if>><a<#if c_service> class="clicked"</#if> href="${base}/service.html"><@s.property value="%{getText('front.nav.special.service')}"/></a></li>
    		<li><a<#if c_search> class="clicked"</#if> href="${base}/search.html"><@s.property value="%{getText('front.nav.search')}"/></a></li>
    		<li><a<#if c_contact> class="clicked"</#if> href="${base}/contact.html"><@s.property value="%{getText('front.nav.contact.us')}"/></a></li>
