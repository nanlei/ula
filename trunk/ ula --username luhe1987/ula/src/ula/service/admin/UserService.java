...
public class UserService extends BaseService {
	...
	public void deleteUserById(String userId) {
		jt.update(SQL_DEL_USER_BY_ID, new Object[] { userId });
	}
	...
	public Map<String, Object> getUserInfoById(String userId) {
		return jt.queryForMap(SQL_GET_USER_BY_ID, new Object[] { userId });
	}
	...
	public void updateUserById(Map<String, Object> parameters) {
		...
		jt.update(SQL_SET_USER_BY_ID, params);
	}
