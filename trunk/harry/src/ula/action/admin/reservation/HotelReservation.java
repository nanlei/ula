...
public class HotelReservation extends CommonAction {
    ...
    public String reserve ( ) {
        ...
        try {
            super.getServiceManager ( )
                    ...
                    .reserve_hotel (this.hotelName , this.guestTotal , this.roomTotal , this.checkinDate , this.checkoutDate , this.name,this.phoneType , this.phoneNumber , this.contactType , this.contact , this.remarks) ;
        }
        catch (Exception e) {
    ...
    public String admin ( ) {
        ...
        try {
            this.hotelReservList = super.getServiceManager ( ).getReservationService ( )
                    .getHoteReservList ( ) ;
        }
        catch (Exception e) {
            super.debug (e.getMessage ( )) ;
    ...
    public String detail ( ) {
        ...
        try {
            this.reservation = super.getServiceManager ( ).getReservationService ( )
                    .detail_hotel (Id) ;
        }
        catch (Exception e) {
            super.debug (e.getMessage ( )) ;
    ...
    public String toString ( ) {
        ...
        return "HotelReservation [name=" + name + ", hotelName=" + hotelName + ", checkinDate=" + checkinDate + ", checkoutDate=" + checkoutDate + ", remarks=" + remarks + ", guestTotal=" + guestTotal + ", roomTotal=" + roomTotal + ", phoneType=" + phoneType + ", phoneNumber=" + phoneNumber + ", contactType=" + contactType + ", contact=" + contact + ", hotelReservList=" + hotelReservList + ", reservation=" + reservation + "]" ;
    }
