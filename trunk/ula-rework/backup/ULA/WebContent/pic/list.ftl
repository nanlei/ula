<@p.page>
	<@app.naviBar navi="图片管理,普通上传,图片信息" />
	<@app.naviInfo helpInfoTitle="查看页面说明" helpInfoContent="本页面显示系统内的所有上传的图片，您可以维护这些信息。">
	</@app.naviInfo>
...
<table class="default" width="100%">
	...
	<tr>
		...
		<td><a href="showPic.action?picId=${pic.PICID}">查看</a> | <a href="deletePic.action?picId=${pic.PICID}" onclick="return confirm('确定要删除该图片么?')">删除</a></td>
	</tr>
